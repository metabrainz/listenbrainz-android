...
interface FeedRepository {
    ...
    suspend fun getFeedEvents(username: String, maxTs: Int? = null, minTs: Int? = null) : Resource<FeedData>
    
    suspend fun getFeedFollowListens(username: String, maxTs: Int? = null, minTs: Int? = null) : Resource<FeedData>
    
    suspend fun getFeedSimilarListens(username: String, maxTs: Int? = null, minTs: Int? = null) : Resource<FeedData>
