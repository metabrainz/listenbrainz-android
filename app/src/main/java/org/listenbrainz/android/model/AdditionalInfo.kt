...
data class AdditionalInfo(
    ...
    var artist_names: List<String>? = null,
    ...
    var release_artist_names: List<String>? = null,
    var release_msid: String? = null,
    var release_mbid: String? = null,
    var spotify_album_artist_ids: List<String>? = null,
    var spotify_album_id: String? = null,
    var spotify_artist_ids: List<String>? = null,
