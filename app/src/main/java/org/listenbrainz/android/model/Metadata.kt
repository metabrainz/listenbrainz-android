...
data class Metadata(
    ...
    @SerialName("listened_at_iso") val listenedAtIso: JsonElement? = null,
    @SerialName("message") val message: String? = null,
    @SerialName("playing_now") val playingNow: JsonElement? = null,
    @SerialName("rating") val rating: Int? = null,
    @SerialName("relationship_type") val relationshipType: String? = null,
    @SerialName("review_mbid") val reviewMbid: String? = null,
    @SerialName("text") val text: String? = null,
    @SerialName("track_metadata") val trackMetadata: TrackMetadata? = null,
    @SerialName("user_name") val username: String? = null,
    @SerialName("users") val usersList: List<String>? = null,
    @SerialName("user_name_0") val user0: String? = null,
    @SerialName("user_name_1") val user1: String? = null
) {
