...
sealed class AppNavigationItem(val route: String, @DrawableRes val iconUnselected: Int, @DrawableRes val iconSelected: Int, val title: String) {
    ...
    object SearchScreen: AppNavigationItem("search",R.drawable.ic_search,R.drawable.ic_search,"Search")
    object BrainzPlayerSearchScreen: AppNavigationItem("brainzplayersearch",R.drawable.ic_search,R.drawable.ic_search,"Player Search")
}
