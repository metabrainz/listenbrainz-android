...
fun AppNavigation(
    ...
    fun goToUserProfile(selectedUsername: String) {
        navController.navigate("${AppNavigationItem.Profile.route}/${if (selectedUsername == "You") loggedInUsername else selectedUsername}")
    }
